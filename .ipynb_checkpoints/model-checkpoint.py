...
class main_model(nn.Module):
    ...
    def forward(self, imgs):
        ...
        x_f_1 = self.fu1(x_c_1, None)
        x_f_2 = self.fu2(x_c_2, x_f_1)
        x_f_3 = self.fu3(x_c_3, x_f_2)
        x_f_4 = self.fu4(x_c_4, x_f_3)
...
class HFF_block(nn.Module):
    def __init__(self, ch_1, ch_2, r_2, ch_int, ch_out, drop_rate=0.):
        ...
        self.norm3 = LayerNorm(ch_1  + ch_int, eps=1e-6, data_format="channels_first")
    ...
    def forward(self, l, f):
        ...
        W_local = self.norm2(W_local)  # 规范化处理后的局部特征
        W_local = self.gelu(W_local)  # 应用GELU激活函数
        ...
        W_local = W_local + l  # 将空间注意力的结果与局部特征相加
        W_local = self.drop_path(W_local)  # 应用DropPath
